...
var _heroSwiper = require("./modules/swiper/hero-swiper");
var _videoPlay = require("./modules/video/video-play");
var _openMenu = require("./modules/open-menu/open-menu");
var _toursSwiper = require("./modules/swiper/tours-swiper");
var _trainerSwiper = require("./modules/swiper/trainer-swiper");
var _reviewsSwiper = require("./modules/swiper/reviews-swiper");
var _advantagesSwiper = require("./modules/swiper/advantages-swiper");
var _gallerySwiper = require("./modules/swiper/gallery-swiper");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _videoPlay.playVideo)();
  (0, _openMenu.openMneu)();
  (0, _advantagesSwiper.setSwiperClasses)();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    _heroSwiper.heroSwiper.init();
    _toursSwiper.toursSwiper.init();
    _trainerSwiper.trainerSwiper.init();
    _reviewsSwiper.reviewsSwiper.init();
    _advantagesSwiper.advantagesSwiper.init();
    _gallerySwiper.gallerySwiper.init();
  });
});

// ---------------------------------

},{"./modules/form-validate/form":3,"./modules/open-menu/open-menu":9,"./modules/swiper/advantages-swiper":10,"./modules/swiper/gallery-swiper":11,"./modules/swiper/hero-swiper":12,"./modules/swiper/reviews-swiper":13,"./modules/swiper/tours-swiper":14,"./modules/swiper/trainer-swiper":15,"./modules/video/video-play":16,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
exports.openMneu = void 0;
var header = document.querySelector('[data-header="container"]');
var toggleBtn = header.querySelector('[data-header="toggle"]');
var body = document.body;
var menuLinks = header.querySelectorAll('[data-mneu="link"]');
var sprite = toggleBtn.querySelector('use');
...
var openMneu = exports.openMneu = function openMneu() {
  if (header) {
...
exports.setSwiperClasses = exports.advantagesSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var breakpoint = window.matchMedia('(min-width:1200px)');
var advantagesSwiper = exports.advantagesSwiper = new _swiper.default('[data-swiper="advantages"]', {
...
var setSwiperClasses = exports.setSwiperClasses = function setSwiperClasses() {
  if (document.querySelector('[data-swiper="advantages"]')) {
    var container = document.querySelector('[data-swiper="advantages"]');
    var wrapper = container.querySelector('[data-swiper="advantages-wrapper"]');
    var slide = wrapper.querySelectorAll('[data-swiper="advantages-slide"]');
    if (breakpoint.matches) {
      container.classList.add('swiper');
      wrapper.classList.add('swiper-wrapper');
      slide.forEach(function (item) {
        return item.classList.add('swiper-slide');
      });
    } else {
...
},{"../../vendor/swiper":19}],11:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.gallerySwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var gallerySwiper = exports.gallerySwiper = new _swiper.default('[data-swiper="gallery"]', {
  direction: 'horizontal',
  loop: true,
  navigation: {
...
exports.heroSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var heroSwiper = exports.heroSwiper = new _swiper.default('[data-swiper="hero"]', {
  direction: 'horizontal',
  loop: true,
  pagination: {
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var reviewsSwiper = exports.reviewsSwiper = new _swiper.default('[data-swiper="reviews"]', {
  direction: 'horizontal',
  loop: true,
  navigation: {
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var toursSwiper = exports.toursSwiper = new _swiper.default('[data-swiper="tours"]', {
  direction: 'horizontal',
  loop: false,
  navigation: {
...
exports.trainerSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var trainerSwiper = exports.trainerSwiper = new _swiper.default('[data-swiper="training"]', {
  direction: 'horizontal',
  loop: false,
  navigation: {
...
},{"../../vendor/swiper":19}],16:[function(require,module,exports){
"use strict";
...
var container = document.querySelector('[data-video="video"]');
var preview = document.querySelector('[data-video="preview"]');
var playBtn = document.querySelector('[data-video="btn"]');
var showPlayBnt = function showPlayBnt() {
  container.classList.add('is-enabled');
};
var createIframe = function createIframe(parent, _ref) {
  var url = _ref.url,
    title = _ref.title;
  var iframe = document.createElement('iframe');
  iframe.setAttribute('src', "".concat(url, "?autoplay=1"));
